...
import UIPlugin from 'phaser3-rex-plugins/templates/ui/ui-plugin';//'templates/ui/ui-plugin.js';

const COLOR_PRIMARY = 0x4e342e;
const COLOR_LIGHT = 0x7b5e57;
const COLOR_DARK = 0x260e04;

const Random: any = Phaser.Math.Between;
...
export default class Demo extends Phaser.Scene {
    ...
    create() {
        ...
        var print: any;
        var scrollMode: any = 0; // 0:vertical, 1:horizontal
        ...
        gridTable
            .on('cell.down', function (cellContainer, cellIndex) {
                print.text += 'pointer-down ' + cellIndex + ': ' + cellContainer.text + '\n';
            }, this)
            .on('cell.up', function (cellContainer, cellIndex) {
                print.text += 'pointer-up ' + cellIndex + ': ' + cellContainer.text + '\n';
            }, this)
            ...
            .on('cell.1tap', function (cellContainer, cellIndex) {
                print.text += '1 tap (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.2tap', function (cellContainer, cellIndex) {
                print.text += '2 taps (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.pressstart', function (cellContainer, cellIndex) {
                print.text += 'press-start (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.pressend', function (cellContainer, cellIndex) {
                print.text += 'press-end (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.swiperight', function (cellContainer, cellIndex) {
                print.text += 'swipe-right (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.swipeleft', function (cellContainer, cellIndex) {
                print.text += 'swipe-left (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.swipeup', function (cellContainer, cellIndex) {
                print.text += 'swipe-up (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
            .on('cell.swipedown', function (cellContainer, cellIndex) {
                 print.text += 'swipe-down (' + cellIndex + ': ' + cellContainer.text + ')\n';
            }, this)
...
var CreateItems = function (count) {
    var data: Array<{id:number, color: number}> = [];
